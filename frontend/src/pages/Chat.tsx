  ...
  return (
      ...
      <Box sx={{display:'flex', width:'100%',height:'100%', mt:3, gap:3}}>
          <Box sx={{display:{md:'flex',sm:'none',xs:'none',flex:0.2, flexDirection:'column'}}}>
            <Box sx={{display:'flex',width:'100%',height:'60vh',bgcolor:'rgb(17,23,39)',borderRadius:5,flexDirection:'column',mx:3,
            }}>
        ...
        <Typography sx={{textAlign:'center',fontSize:'40px',color:'white',mb:2,mx:'auto'}}>Model - Gemini Pro</Typography>
        ...
        <Box>
          <div style={{width:'90%',padding:'20px',borderRadius:8,backgroundColor:'rgb(17,27,39)',display:'flex',margin:'auto'}}>
          <input ref={inputRef} style={{width:'100%',backgroundColor:'transparent',padding:'10px',border:'none',outline:'none',color:'white',fontSize:'20px'}}/>
